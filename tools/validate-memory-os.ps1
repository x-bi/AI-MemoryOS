...
$required = @(
  ...
  "templates\auto-b-tier-proposal.md",
  "templates\auto-labels.json",
  "templates\approval-sheet.md",
  "templates\auto-cycle-summary.md",
  "templates\auto-runs-dashboard.md",
  "templates\auto-dashboard-home-link.md",
  ...
  "tools\auto\audit-content-quality.ps1",
  "tools\auto\audit-link-integrity.ps1",
  "tools\auto\audit-skill-coverage.ps1",
  "tools\auto\audit-router-consistency.ps1",
  "tools\auto\audit-proposal-health.ps1",
  "tools\auto\model-semantic-audit.ps1",
  "tools\auto\iterate-stale-content.ps1",
  "tools\auto\iterate-duplicate-merge.ps1",
  "tools\auto\iterate-skill-gaps.ps1",
  "tools\auto\iterate-router-refinement.ps1",
  "tools\auto\iterate-promotion-candidates.ps1",
  "tools\auto\optimize-frontmatter.ps1",
  "tools\auto\optimize-dashboard-sync.ps1",
  "tools\auto\optimize-skill-consistency.ps1",
  "tools\auto\optimize-unused-pages.ps1",
  "tools\auto\optimize-adapter-gate-sync.ps1",
  "tools\auto\optimize-core-rules.ps1",
  "tools\auto\run-all.ps1",
  "tools\auto\start-cycle.ps1",
  "tools\auto\repair-failed-cycle.ps1",
  "tools\auto\review-cycle.ps1",
