---
title: "Archive stale content: domains\backend\auth.md"
type: proposal
status: rejected
...
# Proposal: Archive stale content: domains\backend\auth.md
...
- Evidence path: domains\backend\auth.md
