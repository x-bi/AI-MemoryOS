---
title: "Archive stale content: adapters\cursor\rules\memory-os.md"
type: proposal
status: rejected
...
# Proposal: Archive stale content: adapters\cursor\rules\memory-os.md
...
- 关联对象：adapters\cursor\rules\memory-os.md
...
- Evidence path: adapters\cursor\rules\memory-os.md
