---
run_id: "b81483baba42"
script: "iterate-promotion-candidates"
triggered_by: "manual"
model_profile: ""
model_invocations_count: 0
model_tokens_estimate: 0
started_at: "2026-06-01T10:12:14.3170668+08:00"
duration_seconds: 0
exit_code: 0
findings_count: 0
actions_count: 1
...
# 自动运行日志：iterate-promotion-candidates
...
| # | 等级 | 操作 | 目标 | 状态 |
|---|---|---|---|---|
| 1 | B 提案级 | 标记晋升候选 | proposal-health | 已跳过：没有候选项 |
...
~~~json
{
    ...
    "actions":  [
                    {
                        "tier":  "B",
                        "action":  "mark-promotion-candidate",
                        "target":  "proposal-health",
