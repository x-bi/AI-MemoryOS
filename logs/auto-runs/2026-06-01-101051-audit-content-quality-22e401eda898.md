...
started_at: "2026-06-01T10:10:46.0929186+08:00"
duration_seconds: 6
exit_code: 0
findings_count: 46
actions_count: 0
pending_decisions_count: 46
...
| 46 | 警告 | 内容重复 | 多个文件的正文归一化后完全一致，需要人工判断是否合并。 | dashboard\auto-runs.md; templates\auto-runs-dashboard.md | B 提案级 |
...
| 46 | 多个文件的正文归一化后完全一致，需要人工判断是否合并。 | B 提案级 | dashboard\auto-runs.md; templates\auto-runs-dashboard.md | pending |
