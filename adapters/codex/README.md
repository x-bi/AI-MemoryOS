...
- 全局 `C:\Users\btf\.codex\AGENTS.md` 只保留 bootstrap，引导每个输入读取 `C:\Users\btf\AI-MemoryOS\adapters\codex\gate.md`。
- `C:\Users\btf\AI-MemoryOS\adapters\codex\gate.md` 是 Codex 回答风格、Memory OS Gate、验证策略和读写边界的单一入口。
...
- 每个输入先读取 `gate.md`，再按其中规则做 L0-L3 判定。
