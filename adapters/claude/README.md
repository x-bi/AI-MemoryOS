...
- `bootstrap.md`: Lightweight per-input loader that decides whether to read the full gate. Generated by `tools/sync-adapter-gates.ps1`.
- `CLAUDE.md`: Full Claude Code Memory OS gate. Generated by `tools/sync-adapter-gates.ps1`.
- `templates/`: Claude gate/bootstrap and skill adapter templates.
...
- Do not hand-edit `bootstrap.md` or `CLAUDE.md`; update `adapters/gate-source/**` or `adapters/claude/templates/` and run `tools/sync-adapter-gates.ps1`.
